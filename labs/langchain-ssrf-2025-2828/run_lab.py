...
def _write_report(action, url, status, blocked_reason=""):
    ...
    report_path = report_dir / f"langchain_ssrf_2025_2828_{timestamp}.json"
    report_path.write_text(json.dumps(report, indent=2))
    latest_path = report_dir / "langchain_ssrf_2025_2828_latest.json"
...
def main():
    ...
    preferred_base = int(os.environ.get("LAB_PORT_BASE", "9400"))
    ...
    print("LangChain RequestsToolkit SSRF lab running:")
